...
def loads(text: str) -> dict:
  """Get the JSON representation of an HCL2 string."""
  # append new line as a workaround for
  # https://github.com/lark-parser/lark/issues/237
  # Lark doesn't support a EOF token so our grammar can't look for
