...
#tfimport-terraform import google_compute_resource_policy.vm_placementpolicy_spread projects/__project__/regions/us-west1/resourcePolicies/vm-placementpolicy-spread
