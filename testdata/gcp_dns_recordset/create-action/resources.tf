...
#tfimport-terraform import google_dns_record_set.gcp_dns_bucket_insert_action_test_1 __project__/dns-managed-zone/gcp_dns_bucket_insert_action_test_1/DNSKEY
